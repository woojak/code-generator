...
public final class LabelRenderer {
    ...
    private static void render(
            Canvas c, int width, int height, LabelData d)
            throws Exception {
        ...
        // v1.1: long OCR product names are automatically scaled
        // instead of running outside the label.
        textFit(
                c, p, d.productLine,
                3.0f, 20.1f,
                42.0f, 4.2f, 2.2f,
    ...
    private static void textFit(
            Canvas c, Paint p,
            String value,
            float xMm, float yMm,
            float maxWidthMm,
            float preferredSizeMm,
            float minSizeMm,
            float sx, float sy,
            boolean normal) {
